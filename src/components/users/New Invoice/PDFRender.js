        ...
        <Page size='A4' style={styles.page}>
            <View>
                ...
                <View style={styles.flexContainer}>
                    ...
                    <View style={{ ...styles.stack, justifyContent: 'right', alignItems: 'right' }}>
                ...
                <View style={styles.flexContainer}>
                    ...
                    {date && <Text style={styles.smallLabel}>Date of issue</Text>}
                    {invoiceNumber && <Text style={styles.smallLabel}>Invoice No.</Text>}
                </View>
                <View style={styles.flexContainer}>
                    {<View style={{ ...styles.stack, justifyContent: 'right', alignItems: 'right' }}>
                    ...
                    {date && <Text style={styles.smallText}>{date}</Text>}
            ...
            <View style={styles.table}>
                ...
                <View>
                    {items && items.map((item, index) => (
                        <View key={item.id} style={{ backgroundColor: index % 2 === 0 ? '#eee' : '#ddd', ...styles.flexContainer }}>
                            ...
                            <Text style={styles.invoiceText}>GHS {item.totalAmount}</Text>
                        </View>
                    ))}
                </View>
